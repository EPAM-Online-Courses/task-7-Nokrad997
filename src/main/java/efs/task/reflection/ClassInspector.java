...
public class ClassInspector {
  ...
  /**
   * Metoda powinna wyszukać we wszystkich zadeklarowanych przez klasę polach te
   * które oznaczone
   * są adnotacją podaną jako drugi parametr wywołania tej metody. Wynik powinien
   * zawierać tylko
  ...
  /**
   * Metoda powinna wyszukać wszystkie zadeklarowane bezpośrednio w klasie metody
   * oraz te
   * implementowane przez nią pochodzące z interfejsów, które implementuje. Wynik
   * powinien zawierać
   * tylko unikalne nazwy metod (bez powtórzeń).
   *
   * @param type klasa (typ) poddawany analizie
   * @return lista zawierająca tylko unikalne nazwy metod zadeklarowanych przez
   *         klasę oraz te
   *         implementowane
   */
  ...
  /**
   * Metoda powinna odszukać konstruktor zadeklarowany w podanej klasie który
   * przyjmuje wszystkie
   * podane parametry wejściowe. Należy tak przygotować implementację aby nawet w
   * przypadku gdy
   * pasujący konstruktor jest prywatny udało się poprawnie utworzyć nową
   * instancję obiektu
   * <p>
   * Przykładowe użycia:
   ...
   * @return nowa instancja klasy podanej jako parametr zainicjalizowana podanymi
   *         parametrami
   * @throws Exception wyjątek spowodowany nie znalezieniem odpowiedniego
   *                   konstruktora
   */
